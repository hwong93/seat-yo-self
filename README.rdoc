...
- format picture size on restaurant index page
- format picture and title on restaurant show page
- figure out how to take the date out restaurant opening & closing time. Maybe add text vs .open_hours .close_hours method
